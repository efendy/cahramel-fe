                ...
                <div className="mt-1 flex items-center">
                    <div className="h-12 w-12 overflow-hidden rounded-full ">
                        {imageUpload?.length > 0 ?
                            (
                                <img className="w-full h-full" src={URL.createObjectURL(imageUpload[0])} />
                            ) :
                            companyProfile?.image_profile?.data
                                ?
                                <img className="w-full h-full" src={companyProfile.image_profile.data?.attributes?.url} />
                                : (
                    ...
                    {isOwner ? (
                        <input {...register('image_blobs')} type="file"
                ...
                <div className="flex justify-end sm:col-span-6">
                    ...
                    >
                        {isCreating || isUpdating ? (
                            <svg aria-hidden="true" className="mr-2 w-4 h-4 text-gray-200 animate-spin fill-gray-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
