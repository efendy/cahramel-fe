...
import { useSetCompanyMutation } from "@queries/use-company"
...
export const CompanyForm = () => {
    ...
    const { mutate } = useSetCompanyMutation();
    ...
    return (
        <form onSubmit={onSubmit} className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
