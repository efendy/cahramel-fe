          ...
          <li key={step} className={classNames(stepIdx !== steps.length - 1 ? 'pr-4 sm:pr-6 lg:pr-10' : '', 'relative')}>
            {currentStepIndex > stepIdx ? (
              <>
                ...
                >
                  <CheckIcon className="h-3 w-3 lg:h-5 lg:w-5 text-white" aria-hidden="true" />
              ...
              <>
                ...
                <div
                  className="group relative flex h-6 w-6 lg:h-8 lg:w-8 items-center justify-center rounded-full border-2 border-gray-300 bg-white"
                >
                  <span
