    ...
    <ClientLayout>
      <div className="m-4">
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-16">
          <div className="mt-4 text-center lg:col-start-8 lg:col-end-13 lg:row-start-1 lg:mt-4 xl:col-start-9">
            <button
              type="button"
              className="mb-8 w-full rounded-md border border-transparent bg-amber-600 py-2 px-4 text-sm font-medium text-white shadow hover:bg-amber-700 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2"
            >
              Add leave
            </button>
