...
const ConfigureOnboardingPage = () => {
  ...
  return (
    <>
        ...
        <div className="px-4 mt-4">
          <div className="sm:flex sm:items-center">
            <div className="sm:flex-auto">
              <h1 className="text-xl font-semibold text-gray-900">Configure Onboarding</h1>
      ...
      <SlidePanel open={open} setOpen={setOpen} title={"Configure New Onboarding"} subtitle={"The healthiest response to life is joy."}>
      </SlidePanel>
    </>
  )
};
